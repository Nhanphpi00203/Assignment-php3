        ...
        <form action="{{ route('client.contact.store') }}" method="POST" enctype="multipart/form-data" class="card">
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <small id="phoneId" class="form-text text-muted">{{  $errors->first('phone') }}</small>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <small id="addressId" class="form-text text-muted">{{  $errors->first('address') }}</small>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <small id="titleId" class="form-text text-muted">{{  $errors->first('title') }}</small>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <div id="fileId" class="form-text">{{  $errors->first('file') }}</div>
                </div>
